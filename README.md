...
The `vendor` directory provides a collection of SDKs for 3rd party chip vendors, only bouffalo lab's specific product is supported now. To build an applicaiton using the SDK, you can refer to the following documntation: [specific product SDK](./vendor/bouffalo/README.md)
